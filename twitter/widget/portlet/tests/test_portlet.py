...
from twitter.widget.portlet import twitterwidgetportlet

from twitter.widget.portlet.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        ...
        self.assertEquals(portlet.addview,
                          'twitter.widget.portlet.twitterWidgetPortlet')
